...
from .models import CustomUser, Message, OTPVerification, SMSMessage, Conversation, ChatMessage
...
class ConversationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__phone_number', 'phone_number')
    readonly_fields = ('created_at', 'updated_at')


@admin.register(ChatMessage)
class ChatMessageAdmin(admin.ModelAdmin):
    list_display  = ('conversation', 'sender', 'recipient_phone', 'direction', 'status', 'twilio_message_sid', 'created_at')
    list_filter   = ('direction', 'status', 'created_at')
    search_fields = ('sender', 'recipient_phone', 'message_body', 'twilio_message_sid')
    readonly_fields = ('twilio_message_sid', 'created_at', 'updated_at')
